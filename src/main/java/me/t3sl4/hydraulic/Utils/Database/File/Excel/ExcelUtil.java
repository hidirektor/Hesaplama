...
public class ExcelUtil {
    ...
    public static void readExcel4Kampana(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                hydraulicData.kampanaDegerleri.add(Integer.parseInt(data));
            }
    ...
    public static void readExcel4Motor(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.motorDegerleri.add(data);
            }
    ...
    public static void readExcel4PompaHidros(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.pompaDegerleriHidros.add(data);
            }
    ...
    public static void readExcel4PompaKlasik(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.pompaDegerleriKlasik.add(data);
            }
    ...
    public static void readExcel4PompaTumu(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.pompaDegerleriTumu.add(data);
            }
    ...
    public static void readExcel4KilitMotor(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.kilitMotorDegerleri.add(data);
            }
    ...
    public static void readExcel4KilitPompa(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.kilitPompaDegerleri.add(data);
            }
    ...
    public static void readExcel4ValfTipi1(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.valfTipiDegerleri1.add(data);
            }
    ...
    public static void readExcel4ValfTipi2(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.valfTipiDegerleri2.add(data);
            }
    ...
    public static void readExcel4HidrosMotorDegerleri380(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.motorDegerleriHidros380.add(data);
            }
    ...
    public static void readExcel4IthalMotorDegerleri380(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.motorDegerleriIthal380.add(data);
            }
    ...
    public static void readExcel4HidrosMotorDegerleri220(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.motorDegerleriIthal220.add(data);
            }
    ...
    public static void readExcel4IthalMotorDegerleri220(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.motorDegerleriHidros220.add(data);
            }
    ...
    public static void readExcel4HidrosMotorDegerleri1224(String filePath, HydraulicData hydraulicData) {
        ...
        try (InputStream file = new FileInputStream(filePath)) {
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                if (i >= 2 && i <= 4 && cellA != null && cellA.getCellType() == CellType.STRING) {
                    ...
                    hydraulicData.motorDegerleriHidros12.add(dataA);
                }

                if (cellB != null && cellB.getCellType() == CellType.STRING) {
                    String dataB = cellB.getStringCellValue();
                    hydraulicData.motorDegerleriHidros24.add(dataB);
                }
            }
    ...
    public static void readExcel4IthalMotorDegerleri1224(String filePath, HydraulicData hydraulicData) {
        ...
        try (InputStream file = new FileInputStream(filePath)) {
            ...
            for (int i = 1; i < rowCount; i++) {
                ...
                if (i >= 2 && i <= 4 && cellA != null && cellA.getCellType() == CellType.STRING) {
                    String dataA = cellA.getStringCellValue();
                    hydraulicData.motorDegerleriIthal12.add(dataA);
                }

                if (cellB != null && cellB.getCellType() == CellType.STRING) {
                    String dataB = cellB.getStringCellValue();
                    hydraulicData.motorDegerleriIthal24.add(dataB);
                }
            }
    ...
    public static void readExcel4HidrosPompaKapasite(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.pompaKapasiteDegerleriHidros.add(data);
            }
    ...
    public static void readExcel4IthalPompaKapasite(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.pompaKapasiteDegerleriIthal.add(data);
            }
    ...
    public static void readExcel4HidrosTankDikey(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.tankKapasitesiDegerleriHidrosDikey.add(data);
            }
    ...
    public static void readExcel4HidrosTankYatay(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.tankKapasitesiDegerleriHidrosYatay.add(data);
            }
    ...
    public static void readExcel4IthalTankDikey(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.tankKapasitesiDegerleriIthalDikey.add(data);
            }
    ...
    public static void readExcel4IthalTankYatay(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.tankKapasitesiDegerleriIthalYatay.add(data);
            }
    ...
    public static void readExcel4HidrosPlatform(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.platformDegerleriHidros.add(data);
            }
    ...
    public static void readExcel4HidrosValf(String filePath, HydraulicData hydraulicData) {
        ...
        try(InputStream file = new FileInputStream(filePath)) {
            ...
            for(int i=1; i<rowCount; i++) {
                ...
                Cell cell = row.getCell(0);
                String data = cell.getStringCellValue();
                hydraulicData.valfDegerleriHidros.add(data);
            }
