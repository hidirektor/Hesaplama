...
public class KlasikController {
    ...
    private void imageTextEnable(int x, int y, String calculatedImage) {
        if(calculatedImage.equals("cift_hiz")) {
            ...
            addTextToList("235 mm", 530, 330, 0, 11, Color.WHITE);
            addTextToList("50 mm", 507, 372, 90, 11, Color.WHITE);
            addTextToList("50 mm", 565, 420, 0, 11, Color.WHITE);
            addTextToList("230 mm", 590, 377, -90, 11, Color.WHITE);
            addTextToList("60 mm", 605, 323, 0, 11, Color.WHITE);
            addTextToList("100 mm", 605, 280, 0, 11, Color.WHITE);
            addTextToList("Ø30", 612, 340, 0, 11, Color.WHITE);
            addTextToList("Ø40", 615, 305, 0, 11, Color.WHITE);
            addTextToList("Ø40", 615, 255, 0, 11, Color.WHITE);
            addTextToList("70 mm", 665, 420, 0, 11, Color.WHITE);
            addTextToList("50 mm", 730, 420, 0, 11, Color.WHITE);
            addTextToList("70 mm", 810, 420, 0, 11, Color.WHITE);
            addTextToList("70 mm", 843, 382, 90, 11, Color.WHITE);
            addTextToList("163 mm", 720, 365, -90, 11, Color.WHITE);
            addTextToList("Ø30", 736, 328, 0, 11, Color.WHITE);
            addTextToList("Ø52", 738, 400, 0, 11, Color.WHITE);
            addTextToList("400 mm", 780, 295, 0, 11, Color.WHITE);
            addTextToList("Soğutma Radyatörü", 680, 250, 0, 11, Color.WHITE);
            addTextToList("328 mm", 710, 280, 0, 11, Color.WHITE);
            addTextToList("235 mm", 810, 280, 0, 11, Color.WHITE);
            addTextToList("40 mm", 785, 220, 0, 9, Color.WHITE);
            addTextToList("Ø8", 645, 226, 0, 11, Color.WHITE);
            addTextToList("100 mm", 815, 230, 90, 9, Color.WHITE);
            addTextToList("60 mm", 845, 240, 90, 9, Color.WHITE);
            ...
            addTextToList("100 mm", 548, 230, 0, 11, Color.WHITE);
            addTextToList("50 mm", 507, 290, 90, 11, Color.WHITE);
            addTextToList("235 mm", 530, 330, 0, 11, Color.WHITE);
            addTextToList("50 mm", 507, 372, 90, 11, Color.WHITE);
            addTextToList("50 mm", 565, 420, 0, 11, Color.WHITE);
            addTextToList("230 mm", 590, 377, -90, 11, Color.WHITE);
            ...
            addTextToList("235 mm", 530, 330, 0, 11, Color.WHITE);
            addTextToList("100 mm", 507, 372, 90, 11, Color.WHITE);
            addTextToList("50 mm", 565, 420, 0, 11, Color.WHITE);
            addTextToList("230 mm", 590, 377, -90, 11, Color.WHITE);
            addTextToList("60 mm", 605, 323, 0, 11, Color.WHITE);
            addTextToList("100 mm", 605, 280, 0, 11, Color.WHITE);
